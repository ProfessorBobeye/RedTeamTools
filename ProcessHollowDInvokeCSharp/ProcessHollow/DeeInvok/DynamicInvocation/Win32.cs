...
namespace DeeInvok.DynamicInvocation
{
    ...
    public static class Win32
    {
        ...
        /// <returns></returns>
        public static IntPtr OpenProcess(SharedData.Win32.Kernel32.ProcessAccessFlags dwDesiredAccess, bool bInheritHandle, UInt32 dwProcessId)
        {
        ...
        public static class Delegates
        {
            ...
            public delegate IntPtr OpenProcess(
                SharedData.Win32.Kernel32.ProcessAccessFlags dwDesiredAccess,
                bool bInheritHandle,
                UInt32 dwProcessId
            );
